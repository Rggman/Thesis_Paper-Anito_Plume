...
\section{A.1 Clearance Form}
\includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{RESEARCH ETHICS REVIEW FORM.pdf}

%\includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{clearance.pdf}
\section{A.2 General Checklist}
\includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{General Research Ethics Checklist.pdf}

\section{A.3 Checklist A - Human Participants}
\includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{Checklist_A.pdf}
