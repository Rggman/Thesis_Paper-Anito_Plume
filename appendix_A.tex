...
\section{Clearance Form}
\includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{AnitoPlumeV2-Research-Ethics-Review-Form.pdf}

%\includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{clearance.pdf}
\section{General Checklist}
\includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{General Research Ethics Checklist_V2.pdf}

\section{Checklist A - Human Participants}
\includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{Checklist_A_V3.pdf}

\section{Informed Consent Form}
\includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{ANITOPLUME_CONSENTFORM.pdf}
