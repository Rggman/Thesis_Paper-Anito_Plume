...
\chapter{Turnitin Report}
\label{sec:appendixb}

\includepdf[pages=-, scale = 0.9, pagecommand={}, offset = -30 0]{appendixb_anitoplumev2.pdf}
...
%\resperson{Mr. Neil Del Gallego}{Adviser}{College of Computer Studies\\De La Salle University-Manila}{neil.delgallego@dlsu.edu.ph}
